...
Summary: Package for running linters, formatters, static type checkers and code analysis tools on python code in quarto (.qmd) files.
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lintquarto-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lintquarto-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
